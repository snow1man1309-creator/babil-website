...
export default function B2BPricing({ onBack, onBook }: { onBack: () => void, onBook: () => void }) {
  const { t } = useTranslation();

  const PRICING_TIERS: PricingTier[] = [
    {
      id: "01",
      title: t('pricing_b2b.t1.title'),
      category: t('pricing_b2b.t1.cat'),
      price: t('common.custom_quote'),
      delivery: "4-8 Weeks",
      description: t('pricing_b2b.t1.desc'),
      features: t('pricing_b2b.t1.f', { returnObjects: true }) as string[]
    },
    {
      id: "02",
      title: t('pricing_b2b.t2.title'),
      category: t('pricing_b2b.t2.cat'),
      price: t('common.custom_quote'),
      delivery: "Monthly",
      description: t('pricing_b2b.t2.desc'),
      features: t('pricing_b2b.t2.f', { returnObjects: true }) as string[]
    },
    {
      id: "03",
      title: t('pricing_b2b.t3.title'),
      category: t('pricing_b2b.t3.cat'),
      price: t('common.custom_quote'),
      delivery: "Project Based",
      description: t('pricing_b2b.t3.desc'),
      features: t('pricing_b2b.t3.f', { returnObjects: true }) as string[]
    },
    {
      id: "04",
      title: t('pricing_b2b.t4.title'),
      category: t('pricing_b2b.t4.cat'),
      price: t('common.custom_quote'),
      delivery: "2-4 Weeks",
      description: t('pricing_b2b.t4.desc'),
      features: t('pricing_b2b.t4.f', { returnObjects: true }) as string[]
    },
    {
      id: "05",
      title: t('pricing_b2b.t5.title'),
      category: t('pricing_b2b.t5.cat'),
      price: t('common.custom_quote'),
      delivery: "Project Based",
      description: t('pricing_b2b.t5.desc'),
      features: t('pricing_b2b.t5.f', { returnObjects: true }) as string[]
    },
    {
      id: "06",
      title: t('pricing_b2b.t6.title'),
      category: t('pricing_b2b.t6.cat'),
      price: t('common.custom_quote'),
      delivery: "5-10 Days",
      description: t('pricing_b2b.t6.desc'),
      features: t('pricing_b2b.t6.f', { returnObjects: true }) as string[]
    }
  ];
                    ...
                    <ul className="space-y-3 mb-8">
                        {tier.features.map((feature, i) => (
                            <li key={i} className="flex items-start gap-2 text-sm">
                                <Check className="size-4 text-red-500 mt-0.5 shrink-0" />
                                <span>{feature}</span>
                            </li>
                        ))}
                    </ul>
