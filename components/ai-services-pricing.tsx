...
export default function AiServicesPricing({ onBack, onBook }: { onBack: () => void, onBook: () => void }) {
  const { t } = useTranslation();

  const PRICING_TIERS: PricingTier[] = [
    {
      id: "01",
      title: t('pricing_ai.t1.title'),
      category: t('pricing_ai.t1.cat'),
      price: t('common.custom_quote'),
      delivery: "06-09 Days",
      description: t('pricing_ai.t1.desc'),
      features: t('pricing_ai.t1.f', { returnObjects: true }) as string[]
    },
    {
      id: "02",
      title: t('pricing_ai.t2.title'),
      category: t('pricing_ai.t2.cat'),
      price: t('common.custom_quote'),
      delivery: "06-09 Days",
      description: t('pricing_ai.t2.desc'),
      features: t('pricing_ai.t2.f', { returnObjects: true }) as string[]
    },
    {
      id: "03",
      title: t('pricing_ai.t3.title'),
      category: t('pricing_ai.t3.cat'),
      price: t('common.custom_quote'),
      delivery: "06-09 Days",
      description: t('pricing_ai.t3.desc'),
      features: t('pricing_ai.t3.f', { returnObjects: true }) as string[]
    },
    {
      id: "04",
      title: t('pricing_ai.t4.title'),
      category: t('pricing_ai.t4.cat'),
      price: t('common.custom_quote'),
      delivery: "06-09 Days",
      description: t('pricing_ai.t4.desc'),
      features: t('pricing_ai.t4.f', { returnObjects: true }) as string[]
    },
    {
      id: "05",
      title: t('pricing_ai.t5.title'),
      category: t('pricing_ai.t5.cat'),
      price: t('common.custom_quote'),
      delivery: "06-09 Days",
      description: t('pricing_ai.t5.desc'),
      features: t('pricing_ai.t5.f', { returnObjects: true }) as string[]
    }
  ];
