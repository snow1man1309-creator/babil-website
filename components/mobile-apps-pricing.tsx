...
export default function MobileAppsPricing({ onBack, onBook }: { onBack: () => void, onBook: () => void }) {
  const { t } = useTranslation();

  const PRICING_TIERS: PricingTier[] = [
    {
      id: "01",
      title: t('pricing_mobile.t1.title'),
      category: t('pricing_mobile.t1.cat'),
      price: t('common.custom_quote'),
      delivery: "06-09 Days",
      description: t('pricing_mobile.t1.desc'),
      features: t('pricing_mobile.t1.f', { returnObjects: true }) as string[]
    }
  ];
